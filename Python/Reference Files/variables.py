...
#Answer: A variable ........ Variables are containers for storing data values. It's created when you assign a value to it

"Characteristics or features of variables"
# A variable .........Python variables can hold various data types, including integers, floats, strings, booleans, tuples and lists
...
#The differences 
"In Python, multiple variables can be assigned values in a single line using a comma-separated list of variable names, 
"while chained assignment allows multiple variables to be assigned the same value in a single line.
