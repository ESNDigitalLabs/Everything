...
filePath1 = open('Python/1 Reference File FileHandling/file1.txt', 'w') # folder/folder/filename
# write to file
filePath1.write("This has replaced previous text")
# close the filepath and file/ releasing the resource
filePath1.close()

# filePath1 = open('Python/1 Reference File FileHandling/erica.txt', 'w') # folder/folder/filename
# # write to file
# filePath1.write("Python Programming - creating a file")
# # close the filepath and file/ releasing the resource
# filePath1.close()
