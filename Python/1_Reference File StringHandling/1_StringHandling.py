...
#  use any comparison operator to compare the letter "a" and "A" (REMEMBER ASCII VALUES - https://www.ascii-code.com/)
...
def joinWords(first, last):
    return first + " " + last
fName = "Erica"
lName = "Samba-Ngoie"
fullName = joinWords(fName, lName)
print(fullName)
