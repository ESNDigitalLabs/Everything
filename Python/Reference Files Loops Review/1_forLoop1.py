...
#print(f"The second character is: {}")
#print(f"The third character is: {}")
#print(f"The fourth character is: {}")
#print(f"The fifth character is: {}")
#print(f"The sixth character is: {}")
#print(f"The seventh character is: {}")
#print(f"The eighth character is: {}")
#print(f"The tenth character is: {}")
